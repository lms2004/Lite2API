...
var adapterCatalog = []AdapterDescriptor{
	{ID: "generic-openai", Name: "OpenAI 兼容接口", Category: "native", Platforms: []string{"OpenAI", "DeepSeek", "Mistral", "Moonshot", "Groq", "Together", "Fireworks", "任意兼容服务"}, Protocols: []string{"openai-chat", "openai-responses"}, AuthModes: []string{"api-key", "none"}, Status: "built-in", Maturity: "stable", License: "n/a", Migration: []string{"api-key"}, Description: "Lite2API 原生接入任意 OpenAI 兼容 Base URL。"},
	...
	{ID: "gemini-openai", Name: "Gemini OpenAI 兼容端点", Category: "native", Platforms: []string{"Gemini"}, Protocols: []string{"openai-chat"}, AuthModes: []string{"api-key"}, Status: "built-in", Maturity: "stable", License: "n/a", Migration: []string{"api-key"}, Description: "Google 官方 OpenAI 兼容端点，可直接使用 Gemini API Key。"},
